...
// In the development environment, it is executed by eval, so it is disabled.
...
checkBrowsers(paths.appPath, isInteractive)
  ...
  .then(port => {
    ...
    const electronDevServer = new WebpackDevServer(electronDevServerConfig, electronCompiler);
    // Electron process
    let electronProcess;
    ...
    electronDevServer.startCallback(() => {
      ...
      console.log(chalk.cyan('Starting the electron app...\n'));
    });
